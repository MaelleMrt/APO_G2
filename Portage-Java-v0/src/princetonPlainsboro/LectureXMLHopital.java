 ...
 * @author Maelle
 */
public class LectureXMLHopital {

    public class LectureXML {

        /// nom du document XML a analyser
        private String nomFichier;
        private final static String repBase = "src/hopital/";
        ...
        public Hopital getDossier() {
            Hopital hopitalCourant = null;
            Date date = null;
                    ...
                    switch (event) {
                        ...
                        case XMLStreamConstants.END_ELEMENT:
                            ...
                            if (parser.getLocalName().equals("dateNaissance")) {
                                ...
                                dateNaissanceCourante = new Date(jour, mois, annee);
                            }
                            ...
                            if (parser.getLocalName().equals("patient")) {
                                ...
                                for (Patient p : patients) {
                                    if (p.getSecu.equals(secuCourante)) {
                                        present = true;
                                        patientCourant = p;
                                    }
                                }
                                ...
                                medecinCourant.ajouterPatient(patientCourant);
