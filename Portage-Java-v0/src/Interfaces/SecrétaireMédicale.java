 ...
 * @author marin
 */
public class Secr�taireM�dicale extends javax.swing.JFrame {

    /**
     * Creates new form Secr�taireM�dicale
     */
    public Secr�taireM�dicale() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextField1.setFont(new java.awt.Font("Bell MT", 0, 11)); // NOI18N
        ...
        jList2.setFont(new java.awt.Font("Bell MT", 0, 11)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Secr�taireM�dicale.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Secr�taireM�dicale().setVisible(true);
            }
        });
    }
